...
class DB_Manager:
    ...
    def insert_project(self, data):
        sql = "INSERT INTO projects (user_id, projects_name, url, status_id) values(?, ?, ?, ?)" # Doğru SQL sorgusunu buraya girin
        self.__executemany(sql, data)
    ...
    def get_statuses(self):
        sql = "SELECT status_name from status" # Doğru SQL sorgusunu buraya girin
    ...
    def get_projects(self, user_id):
        sql = "SELECT * FROM projects WHERE user_id = ?" # Doğru SQL sorgusunu buraya girin
...
"""
    ...
    def update_projects(self, param, data):
        sql = "UPDATE projects SET {param} = ? WHERE project_name = ? AND user_id = ?" # Doğru SQL sorgusunu buraya girin
        self.__executemany(sql, [data]) 


    def delete_project(self, user_id, project_id):
        sql = "DELETE from projects WHERE user_id = ? AND project_id = ?" # Doğru SQL sorgusunu buraya girin
